...
const Sidebar: React.FC<SidebarProps> = ({ isOpen }) => {
  ...
  return (
    <>
      {/* Sidebar */}
      <aside
  className={`fixed bg-white transition-transform transform m-7 min-h-screen rounded-3xl p-2 flex flex-col justify-between shadow-lg lg:relative w-60 lg:w-72 2xl:w-80 ${
